...
<TR CLASS=R2>
<TD CLASS='R2C0'><SPAN></SPAN></TD>
<TD CLASS='R5C1' COLSPAN=2>Фамилия (SN)</TD>
<TD CLASS='R5C1' COLSPAN=4>{ra.PersonLastName}</TD>
<TD CLASS='R5C1'>СНИЛС</TD>
<TD CLASS='R5C8' COLSPAN=4>{ra.PersonSnils}</TD>

</TR>
<TR CLASS=R2>
<TD CLASS='R2C0'><SPAN></SPAN></TD>
<TD CLASS='R5C1' COLSPAN=2>Имя Отчество (G)</TD>
<TD CLASS='R5C1' COLSPAN=4>{ra.PersonFirstName} {ra.PersonPatronymic}</TD>
<TD CLASS='R5C1'>E-Mail (E)</TD>
...
<TR CLASS=R2>
<TD CLASS='R2C0'><SPAN></SPAN></TD>
<TD CLASS='R5C1' COLSPAN=2>Должность (T)</TD>
<TD CLASS='R5C8' COLSPAN=4>{ra.PersonPost}</TD>
<TD CLASS='R5C1'>ИНН</TD>
<TD CLASS='R5C8' COLSPAN=4>{ra.PersonInn}</TD>

</TR>
<TR CLASS=R2>
<TD CLASS='R2C0'><SPAN></SPAN></TD>
<TD CLASS='R5C1' COLSPAN=2>Страна (C)</TD>
<TD CLASS='R5C1' COLSPAN=4>RU</TD>
<TD CLASS='R5C1'>ОГРН</TD>
<TD CLASS='R5C8' COLSPAN=4>{ra.Ogrn}</TD>

</TR>
<TR CLASS=R2>
<TD CLASS='R2C0'><SPAN></SPAN></TD>
<TD CLASS='R5C1' COLSPAN=2>Регион (S)</TD>
<TD CLASS='R5C1' COLSPAN=4>{ra.LocationAddressRegionId}</TD>
<TD CLASS='R5C1'>ИНН ЮЛ</TD>
...
<TD CLASS='R16C1' COLSPAN=11>    Ознакомлен(а) с Порядком УЦ и Пользовательским соглашением, в соответствии со статьёй 428 ГК Российской Федерации полностью и безусловно присоединяюсь к Порядку УЦ ООО «НПЦ '1С'» и принимаю Пользовательское соглашение, условия которых опубликованы на сайте Удостоверяющего центра по адресу http://ca.1c.ru/reglament.pdf и на Портале информационно-технологического сопровождения по адресу https://portal.1c.ru/applications/31/licenseAgreement.
...
<TD CLASS='R18C6' COLSPAN=6 ROWSPAN=4>____________ / {ra.LeaderLastName} {ra.LeaderFirstName} {ra.LeaderPatronymic} /<BR>13.12.2022</TD>
